...
const transfererc721_manager_addr = "0x4e0D0E0e74b35bb64783F75Eba1D74b3C2034BFD"
const helixmetaExchangeAddress = "0xf69746e7f5636d13426f41E38d6445767f682F4C";
...
contract("match ask with taker bid using ETH and WETH", function () {
  it("should approve NFT721 tokenID 1 by maker ask from acc0 to HelixmetaExchange", async function () {
    ...
    const result = await ERC721.methods.approve(transfererc721_manager_addr, 5).send({
      from: accounts[0],
    })
    console.log(result)
  });
  it("should taker bid using ETH", async function () {
    ...
    var makerAsk = {
      ...
      startTime: 1643881562, // startTime in timestamp
      endTime: 1654251566, // endTime in timestamp
